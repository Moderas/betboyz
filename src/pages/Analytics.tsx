              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.9rem' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid var(--color-border)' }}>
                    {['Player', 'Bets', 'Wagered', 'Wins', 'Win %', 'Net P&L', '👍', '👎', '🧸', '🧾 Tax'].map((h) => (
                      <th
                        key={h}
                        style={{
                  ...
                  {players.length === 0 ? (
                    ...
                    players.map((p) => (
                      ...
                      >
                        ...
                        <td style={{ padding: '0.7rem 1.25rem', textAlign: 'right', color: 'var(--color-text-muted)', fontWeight: 600 }}>
                          {p.totalToysUsed ?? 0}
                        </td>
                        <td style={{ padding: '0.7rem 1.25rem', textAlign: 'right', color: (p.totalTaxPaid ?? 0) > 0 ? 'var(--color-red)' : 'var(--color-text-muted)', fontWeight: 600 }}>
                          {p.totalTaxPaid ?? 0} ₪
                        </td>
                      </tr>
                    ))
